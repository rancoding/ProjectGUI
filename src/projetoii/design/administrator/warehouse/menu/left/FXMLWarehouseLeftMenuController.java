...
public class FXMLWarehouseLeftMenuController implements Initializable {
    ...
    /**
     * Switches the pane center and disables current menu button
     */
     ...
     * @param product product menu button
     * @param category category menu button
     * @param brand brand menu button
     * @param size size menu button
     * @param color color menu button
     */
